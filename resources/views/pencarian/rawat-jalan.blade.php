...
@section('content')
    ...
    {{-- Buat array untuk mapping jenis kasir ke nama lengkapnya --}}
    @php
        $jenis = [
            1 => 'Rawat Jalan',
            2 => 'IGD',
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        {{-- <h1 class="h3 mb-0 text-gray-800">Kasir Rawat Jalan {{ $jenis_kasir }} - Pencarian Pasien</h1> --}}
        <h1 class="h3 mb-0 text-gray-800">
            Kasir {{ $jenis[$jenis_kasir] ?? 'Nama belum ditambah' }} - Pencarian Pasien
        </h1>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <form method="GET" action="{{ route('pencarian.rawat-jalan') }}">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Cari NAMA atau NORM..." name="search"
                            ...
                            <tbody>
                                ...
                                @forelse ($pasienList as $pasien)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('kasir.pasien.tagihan', ['norm' => $pasien->NORM, 'jenis_kasir' => $jenis_kasir]) }}"
