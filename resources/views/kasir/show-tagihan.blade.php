...
<div class="card shadow mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="dropdown">
                <button class="btn btn-outline-primary dropdown-toggle" type="button"
                    ...
                    Filter: <strong>{{ $statusFilter == 'proses' ? 'Belum Selesai' : 'Selesai' }}</strong>
                </button>
    ...
    <div class="card-body">
        ...
        <div class="text-center">
            <p>Tidak ada tagihan dengan status <strong>"{{ $statusFilter == 'proses' ? 'Belum Selesai' : 'Selesai' }}"</strong>.</p>
        </div>
        @endforelse
